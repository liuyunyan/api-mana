...
import ThirdEdit from "./components/ThirdEdit";
  ...
  render() {
    ...
    return (
      <Row>
        ...
        >
          <ThirdEdit store={this.store} columns={this.store.columns} onSave={this.handleSave} onCancel={this.handleCancel} values={this.store.values} validateStatus={this.store.validateStatus} />
        </ModalBox>
      </Row>
    );
  }
